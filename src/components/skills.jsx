...
function Skills() {
  return (
    <div className="mx-10 w-auto py-5 mt-28">
      <h2 className="text-2xl font-bold mb-4 flex justify-center text-white font-sans heading">SKILLS</h2>
      ...
      <span className="bg-green-400 rounded-full w-96 h-96 opacity-10 absolute right-0 bottom-96 circle"></span>
